...
from hyurl.feature.feature_set import FeatureSet, CommonFeatureSet, EntityFeatureSet, SpatialFeatureSet
from hyurl.feature.feature import Feature, VectorFeature, OnehotFeature
...
class CommanderNetworkConfig:
    ...
    aggregator: AggregatorConfig = field(default_factory=DenseAggregatorConfig)
    value:      ValueApproximatorConfig = field(default_factory=ValueApproximatorConfig)
